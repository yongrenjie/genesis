...
C_HSQC_COSY.auprog = `noah_hsqc`;

C_HSQC_COSY.preamble = `
"p2      = p1*2"                       ; 1H hard 180
"d2      = 0.5s/cnst2"                 ; JCOMP
...
define delay DC_HSQC_COSY11
define delay DC_HSQC_COSY12
"DC_HSQC_COSY1   = d4-p14/2"
"DC_HSQC_COSY2   = d4+p14/2"
"DC_HSQC_COSY5   = p16+d16+p2/2+d0-p3*2/PI+4u"
"DC_HSQC_COSY6   = d2+p3+p2/2"
"DC_HSQC_COSY7   = DC_HSQC_COSY5+p3-p2/2"
"DC_HSQC_COSY8   = d4-p14/2"
"DC_HSQC_COSY9   = d4+p14/2"
"DC_HSQC_COSY10  = d12-d2-p14/2"
"DC_HSQC_COSY11  = d2-p14/2"
"DC_HSQC_COSY12  = d2+p14/2-p16-d16-de"
