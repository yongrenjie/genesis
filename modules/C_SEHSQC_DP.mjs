...
const C_SEHSQC_DP = {};
export default C_SEHSQC_DP;

C_SEHSQC_DP.shortDescription = `; 13C sensitivity-enhanced HSQC (version 1)
;     [use -DEDIT for multiplicity editing]`

C_SEHSQC_DP.shortCode = `Spv1`;

C_SEHSQC_DP.nuclei = `CH`;

C_SEHSQC_DP.auprog = `noah_hsqc`;

C_SEHSQC_DP.preamble = `
"p2      = p1*2"                       ; 1H hard 180
