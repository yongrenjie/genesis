...
const C_HMBC_CFG = {};
export default C_HMBC_CFG;

C_HMBC_CFG.nuclei = `CH`;

C_HMBC_CFG.shortCode = `Bg`;

C_HMBC_CFG.shortDescription = `; 13C HMBC (using hmbcetgpl3nd gradient scheme)`;

C_HMBC_CFG.auprog = `noah_hmbc`;
