...
"D[ID]a = d24-larger(p2,p22)/2"         ; INEPT
"D[ID]b = p17+d16+p2+d20*2-4u"          ; 15N post-t1, if no editing
"D[ID]c = d26-larger(p2,p22)/2-p19-d16" ; first spin echo after t1
"D[ID]d = d24-larger(p2,p22)/2-p16-d16" ; second spin echo after t1
"D[ID]e = p17+d16-p1*0.78+de+8u"        ; final spin echo for refocusing gradient
...
let pulprog = `
  ...
  50u do:f3
`;
const mod = new NOAHModule("N_SEHSQC_OR", "n15", "Spn", [], "noah_nhsqc", "15N seHSQC", shortDescription, [], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker:
