...
`;
const mod = new NOAHModule("H_TT_CR", "h1", "TT CR", [], "noah_tocsy States noah_cosy States:noah_tocsy States noah_roesy States", "TOCSY (States)/COSY (States):TOCSY (States)/ROESY (States)", shortDescription, [], preamble, pulprog, 2, true);
export default mod;
// vim: syntax=bruker:
