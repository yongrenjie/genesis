...
let pulprog = `
  ...
  d16
  4u
  goscnp ph30   ; acquire 13C seHSQC
  50u
`;
const mod = new NOAHModule("C_SEHSQCJ_OR", "c13", "Spj", [], "noah_hsqc", "13C J-seHSQC", shortDescription, [AF_EDIT], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker:
