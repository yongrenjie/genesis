...
let shortDescription = `; 13C sensitivity-enhanced F2 CLIP-HSQC (double NS, half TD1)`;
let preamble = `
"p2      = p1*2"                       ; 1H hard 180
"d2      = 0.5s/cnst2"                 ; JCOMP
...
`;
const mod = new NOAHModule("C_SEHSQCJ_K", "c13", "Spjk", [Hansen2021AC, Yong2021JMR], "noah_hsqc noah_add", "13C J-seHSQC", shortDescription, [AF_EDIT], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker:
