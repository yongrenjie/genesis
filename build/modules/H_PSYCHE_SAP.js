...
else
{
  ...
  goscnp ph26
`;
const mod = new NOAHModule("H_PSYCHE_SAP", "h1", "P", [Foroozandeh2014ACIE, Moutzouri2017CC], "noah_sapphire", "1D PSYCHE (with SAPPHIRE)", shortDescription, [AF_ES], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker:
