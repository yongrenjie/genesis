...
`;
const mod = new NOAHModule("C_SEHSQC_IA", "c13", "Sip Sap", [Hansen2021AC, Yong2021JMR], "noah_hsqc noah_split", "13C IPAP seHSQC", shortDescription, [AF_EDIT], preamble, pulprog, 1, true);
export default mod;
// vim: syntax=bruker:
