import { Foroozandeh2015CC, Moutzouri2017CC } from "../citation.js";
import { AF_ES } from "../acquFlag.js";
import NOAHModule from "../noahModule.js";
let shortDescription = `; 1H 1D TSE-PSYCHE pure shift spectrum with SAPPHIRE averaging
...
else
{
  ...
  goscnp ph26
`;
const mod = new NOAHModule("H_PSYCHE_TSAP", "h1", "Pt", [Foroozandeh2015CC, Moutzouri2017CC], "noah_sapphire", "1D TSE-PSYCHE (with SAPPHIRE)", shortDescription, [AF_ES], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker
