...
export function makePulprogText(trueModuleNames, allowLoneModule, allowHmbcHom) {
    ...
    pp.push(``, ...paramDefns, ``, auProgsStr, shortTitlesStr, `; module identifiers: ${trueModuleNames.join(" ")}`, `; pulse programme created by genesis-v${version}, https://nmr-genesis.co.uk`, `; ${(new Date()).toString()}`);
    return pp.join("\n");
    // }}}1
}
