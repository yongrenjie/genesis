export class Citation {
    ...
    makePPCitation(): string {
        let volIssue: string;
        if (this.volume === "" && this.issue === "") volIssue = `DOI: ${this.doi}`;
        else if (this.issue === "") volIssue = `${this.volume}`;
        else volIssue = `${this.volume} (${this.issue})`;

        let commaPages: string;
...
export const Yong2021AC = new Citation(
    ...
    [Jon, Eriks, Tim],
    AC, 2022, 94, 4, "2271-2278", "10.1021/acs.analchem.1c04964"
)
export const Kupce2017ACIE = new Citation(
    "NOAH: NMR Supersequences for Small Molecule Analysis and Structure Elucidation",
    [Eriks, Tim],
    ACIE, 2017, 56, 39, "11779-11783", "10.1002/anie.201705506"
)
export const Kupce2018CC = new Citation(
    "Molecular Structure from a Single NMR Supersequence",
    [Eriks, Tim],
    CC, 2018, 54, 52, "7139-7142", "10.1039/C8CC03296C"
)
export const Claridge2019MRC = new Citation(
    "Triplet NOAH Supersequences Optimised for Small Molecule Structure Characterisation",
    [Tim, "M. Mayzel", Eriks],
    MRC, 2019, 57, 11, "946-952", "10.1002/MRC.4887"
)
export const Kupce2019JMR = new Citation(
...
export const Hansen2021AC = new Citation(
    ...
    AC, 2021, 93, 15, "6112-6119", "10.1021/acs.analchem.0c05205"
)
export const Koos2016ACIE = new Citation(
    ...
    ACIE, 2016, 55, 27, "7655-7659", "10.1002/anie.201510938"
)
export const Thiele2009CEJ = new Citation(
    "EASY ROESY: Reliable Cross-Peak Integration in Adiabatic Symmetrized ROESY",
    ["C. M. Thiele", "K. Petzold", "J. Schleucher"],
    "Chem. Eur. J.", 2009, 15, 3, "585-588", "10.1002/chem.200802027"
)
export const Foroozandeh2014ACIE = new Citation(
    "Ultrahigh-Resolution NMR Spectroscopy",
    ["M. Foroozandeh", "R. W. Adams", "N. J. Meharry", "D. Jeannerat", "M. Nilsson", "G. A. Morris"],
    ACIE, 2014, 53, 27, "6990-6992", "10.1002/anie.201404111"
)
export const Foroozandeh2015CC = new Citation(
