export class Citation {
    ...
    makePPCitation(): string {
        let volIssue: string;
        if (this.issue === "") volIssue = `${this.volume}`;
...
export const Kupce2018CC = new Citation(
    ...
    [Eriks, Tim],
    "Chem. Commun.", 2018, 54, 52, "7139-7142", "10.1039/C8CC03296C"
)
...
export const Foroozandeh2015CC = new Citation(
    ...
    "Chem. Commun.", 2015, 51, 84, "15410-15413", "10.1039/C5CC06293D"
)
...
export const Gyongyosi2021AC = new Citation(
    ...
    "Anal. Chem.", 2021, 93, 6, "3096-3102", "10.1021/acs.analchem.0c04124"
)
