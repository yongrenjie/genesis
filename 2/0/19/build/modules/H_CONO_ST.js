...
`;
const mod = new NOAHModule("h1", "CNst", [Kupce2017ACIE], "noah_cosy States:noah_noesy States", shortDescription, [AF_PRESAT_NOE, AF_NOZQS, AF_ES_NOESYONLY], preamble, pulprog, 2, false);
export default mod;
// vim: syntax=bruker:
