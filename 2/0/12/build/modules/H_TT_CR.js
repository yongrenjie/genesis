...
`;
const mod = new NOAHModule("h1", "TcTr", [Kupce2017ACIE], "noah_tocsy States noah_cosy States:noah_tocsy States noah_roesy States", shortDescription, preamble, pulprog);
export default mod;
// vim: syntax=bruker:
