 ...
 *                                    string when NBL < 2.
 */
export function makePulprogText(trueModuleNames, allModules, allowLoneModule) {
    // Initialisation {{{2
    ...
    pp.push(ppShortCodeName, ``, ...shortDescriptions, ``, `;$CLASS=HighRes`, `;$DIM=2D`, `;$TYPE=`, `;$SUBTYPE=`, `;$COMMENT=`, ``, citationText, ``, `#include <Avance.incl>`, `#include <Grad.incl>`, `#include <Delay.incl>`, ``);
    if (useNusFlag) {
