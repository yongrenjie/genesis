...
export function makePulprogText(trueModuleNames, allModules, allowLoneModule, allowHmbcHom) {
    ...
    pp.push(`; ${ppShortCodeName}`, ``, ...shortDescriptions, ``, `; set 'NBL' TopSpin parameter to ${nbl}`, ``, `;$CLASS=HighRes`, `;$DIM=2D`, `;$TYPE=`, `;$SUBTYPE=`, `;$COMMENT=`, ``, citationText, ``, `#include <Avance.incl>`, `#include <Grad.incl>`, `#include <Delay.incl>`, ``);
    if (useNusFlag) {
