...
`;
const mod = new NOAHModule("h1", "TT CN", [Kupce2017ACIE], "noah_tocsy States noah_cosy States:noah_tocsy States noah_noesy States", shortDescription, [], preamble, pulprog, 2, true);
export default mod;
// vim: syntax=bruker:
