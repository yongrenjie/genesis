...
import { replacePSElement, makeDipsi, makeDipsiGenerator, asapMixingPPText } from "./elements.js";
...
export function makePulprogText(trueModuleNames, allModules, allowLoneModule, allowHmbcHom) {
    ...
    // incrementation on every round of l1 {{{2
    ...
    // }}}3
    mainpp.push('}');
    // incrementation every 4 rounds of l1 {{{2
    if (hasInterleaved) {
