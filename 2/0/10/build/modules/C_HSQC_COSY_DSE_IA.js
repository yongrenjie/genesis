...
let shortDescription = `; 13C interleaved HSQC-COSY (2 spin echoes) / HSQC`;
let preamble = `
"p2      = p1*2"                       ; 1H hard 180
"d2      = 0.5s/cnst2"                 ; JCOMP
...
else
{
  ...
  50u do:f2
`;
const mod = new NOAHModule("c13", "Qdseia", [Kupce2017ACIE], "noah_hsqc noah_TS", shortDescription, preamble, pulprog);
export default mod;
// vim: syntax=bruker:
