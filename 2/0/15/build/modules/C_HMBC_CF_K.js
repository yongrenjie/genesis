...
"D[ID]f = p16+d16+p2/2+d3-p3*2/PI+4u"
...
let pulprog = `
  ...
  goscnp ph24
`;
const mod = new NOAHModule("hmbc", "B", [Kupce2017ACIE, Kupce2018CC], "noah_hmbc noah_add", shortDescription, preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker:
