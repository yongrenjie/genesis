...
`;
const mod = new NOAHModule("H_CONO_ST", "h1", "CNst", [], "noah_cosy States:noah_noesy States", "COSY (States):NOESY (States)", shortDescription, [AF_PRESAT_NOE, AF_NOZQS, AF_ES_NOESYONLY], preamble, pulprog, 2, false);
export default mod;
// vim: syntax=bruker:
