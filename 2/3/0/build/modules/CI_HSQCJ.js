import { Yong2021JMR, Enthart2008JMR } from "../citation.js";
...
let pulprog = `
  ...
  50u
`;
const mod = new NOAHModule("CI_HSQCJ", "c13", "Sj", [Yong2021JMR, Enthart2008JMR], "noah_hsqc", "13C J-HSQC", shortDescription, [AF_EDIT1], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker:
