import { Hansen2021AC } from "../citation.js";
...
let pulprog = `
  ...
  50u do:f2
`;
const mod = new NOAHModule("C_SEHSQCT", "c13", "Stp", [Hansen2021AC], "noah_hsqc", "13C seHSQC-TOCSY", shortDescription, [AF_EDIT, AF_INVERT], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker:
