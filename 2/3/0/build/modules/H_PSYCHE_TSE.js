...
"D[ID]a = in17/2"       ; tauA from original pulse programme
...
let pulprog = `
  ...
  goscnp ph26
`;
const mod = new NOAHModule("H_PSYCHE_TSE", "h1", "Pt", [Foroozandeh2015CC], "noah_psyche", "1D TSE-PSYCHE", shortDescription, [AF_ES], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker
