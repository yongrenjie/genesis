import { Enthart2008JMR } from "../citation.js";
...
let pulprog = `
  ...
  50u
`;
const mod = new NOAHModule("C_HSQCJ_K", "c13", "Sjk", [Enthart2008JMR], "noah_hsqc noah_add", "13C J-HSQC", shortDescription, [AF_EDIT], preamble, pulprog, 1, false);
export default mod;
// vim: syntax=bruker:
