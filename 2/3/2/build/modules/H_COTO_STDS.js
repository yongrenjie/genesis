import { AF_ES, AF_NOZQS } from "../acquFlag.js";
...
`;
const mod = new NOAHModule("H_COTO_STDS", "h1", "CTstds", [], "noah_cosy States:noah_tocsy States", "COSY (States):TOCSY (States)", shortDescription, [AF_NOZQS, AF_ES], preamble, pulprog, 2, false);
export default mod;
// vim: syntax=bruker:
