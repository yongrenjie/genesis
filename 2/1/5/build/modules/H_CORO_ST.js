...
`;
const mod = new NOAHModule("H_CORO_ST", "h1", "CRst", [Thiele2009CEJ], "noah_cosy States:noah_roesy States", shortDescription, [AF_NOZQS, AF_ES_ROESYONLY], preamble, pulprog, 2, false);
export default mod;
// vim: syntax=bruker:
