...
`;
const mod = new NOAHModule("H_TT_CN", "h1", "TT CN", [], "noah_tocsy States noah_cosy States:noah_tocsy States noah_noesy States", shortDescription, [], preamble, pulprog, 2, true);
export default mod;
// vim: syntax=bruker:
